...
class spectralLES(object):
    ...
    def __init__(self, comm, N, L, nu, epsilon, Gtype, **kwargs):
        ...
        self.Pres = np.empty((3, *self.nnx))    # Pressure vector
    ...
    def compute_pressure(self):
       ...
       P_hat = -1j*np.sum(self.dU*self.K_Ksq, axis=0) # this doesn't fill P_hat, it points the name "P_hat" to a new scalar field array!
